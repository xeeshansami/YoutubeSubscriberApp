...
//        if(getIntent().hasExtra(GoogleSignInActivity.USER_EMAIL)){
//            emailId = getIntent().getExtras().getString(GoogleSignInActivity.USER_EMAIL);
//        }else{
//            emailId="info.xeeshan@gmail.com";
//        }
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean wasRestored) {
        ...
        if (!wasRestored) {
            ...
            youTubePlayer.cueVideo("j9hzPv0IG88"); //Use cueVideo()  method, if you don't want to play it automatically
